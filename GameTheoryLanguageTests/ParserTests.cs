...

{
    ...
    {
        string input1 = "int x = -5 + 5;";
        string input2 = "int x = (-5 + ( 4 + 3 * ( 4 MOD 5 ) / 1 + 5 ) - 3);";
        string input3 = "int x = ((()());";
    ...
    {
        string input1 = "bool x = TRUE && FALSE;";
        string input2 = "bool x = TRUE || FALSE;";
        string input3 = "bool x = TRUE == FALSE;";
        string input4 = "bool x = TRUE ^^ FALSE;";
        string input5 = "bool x = 1 < 3;";
        string input6 = "bool x = (TRUE && TRUE) || ((TRUE && TRUE) == TRUE);";
        string input7 = "bool x = 1 => 3;";
    ...
    public void FunctionTest()
    {
        ...
        string input3 = "function : (int a, bool b, real c, int d, bool e, real f) -> bool {f}";
    ...
    {
        string input1 = "int x = if (TRUE) then {a} else {a};";
        string input2 = "int x = if (TRUE) then {a} else if (TRUE) then {a} else {a};";
        string input3 = "int x = if (TRUE) then {a};";
        string input4 = "int x = if (TRUE) then {a} else if (TRUE) then {a};";
