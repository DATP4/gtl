...
public class TranspilerTests
{
    ...
    public void AssignmentTest()
    {
        ...
        string input2 = "int x = 3.0;";
        string input3 = "bool x = TRUE;";
        string input4 = "real x = 3.0;";
    ...
    public void BooleanExpressionTest()
    {
        ...
        string input5 = "real test = (TRUE && TRUE) || ((TRUE && TRUE) == TRUE);";
        string input6 = "bool test = (TRUE && TRUE) || ((TRUE && TRUE) == TRUE);";
